...
class _SettingsScreenState extends State<SettingsScreen> {
                ...
                builder: (context, mode, _) {
                  ...
                  return SwitchListTile(
                    ...
                    subtitle: AnimatedSwitcher(
                      ...
                      child: Text(isDark ? 'On' : 'Off', key: ValueKey(isDark)),
                    ),
                    value: isDark,
                    onChanged: (value) {
                ...
                child: Column(
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      subtitle: Text(
                        _prefs!.memoryEnabled
                            ? 'Personas remember you'
                            : 'Personas forget between sessions',
                      ),
  ...
  Future<void> _editPreferredName() async {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'How personas should address you',
    ...
    try {
      final updated = await _prefsService.updatePreferences(
        preferredName: result.isEmpty ? null : result,
      );
      if (!mounted) return;
