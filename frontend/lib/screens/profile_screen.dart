...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _toggleSubscription() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Failed: ${ErrorMapper.map(e)}')));
    }
  }
  ...
  Future<void> _pickAndUploadAvatar() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Upload failed: ${ErrorMapper.map(e)}'),
              ...
              children: [
                GestureDetector(
                  ...
                  child: Stack(
                    children: [
                      hasAvatar
                          ? _NetworkAvatar(url: profile.avatarUrl!)
                          : _BouncyAvatar(initial: _initial(profile.email)),
                      if (_uploadingAvatar)
                        Positioned.fill(
                          child: Container(
                            decoration: BoxDecoration(
  ...
  Future<void> _editDisplayName(UserProfile profile) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed: ${ErrorMapper.map(e)}'),
          backgroundColor: AppColors.error,
        ),
      );
    }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Common: UTC, America/New_York, Asia/Kolkata, Europe/London',
  ...
  Future<void> _confirmDeleteAccount() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This action cannot be undone. All your data, conversations, and memories will be permanently deleted.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
    ...
    final doubleConfirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Type your understanding that this cannot be undone. Press Delete to proceed.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context, false),
